                ...
                <div className="container">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4 readmore__special">
                      ...
                      <div className="row mb-3 mb-md-0 mb-lg-2">
                        <LazyLoadImage src="./img/news/new6.png" alt="anh_new6" />
                        <Link
                          to="#"
                          href="#"
                          className="pt-md-2 text-decoration-none"
                      ...
                      <div className="row mb-3 mb-md-0 mb-lg-2">
                        <LazyLoadImage src="./img/news/new7.png" alt="anh_new6" />
                        <Link
                          to="#"
                          href="#"
                          className="pt-md-2 text-decoration-none"
                      ...
                      <div className="row mb-3 mb-md-0 mb-lg-2">
                        <LazyLoadImage src="./img/news/new8.png" alt="anh_new6" />
                        <Link
                          to="#"
                          href="#"
                          className="pt-md-2 text-decoration-none"
